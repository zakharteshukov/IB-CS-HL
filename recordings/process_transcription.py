...
if __name__ == "__main__":
    log_file = "/Users/macbook/Downloads/mfs/education/SSIS/IB CS HL/recordings/logs/whisper-transcription-W6.log"
    original_output = "/Users/macbook/Downloads/mfs/education/SSIS/IB CS HL/recordings/transcripts/original/M2027_W6_A1.3.1-A1.3.4.txt"
    formatted_output = "/Users/macbook/Downloads/mfs/education/SSIS/IB CS HL/recordings/transcripts/formatted/M2027_W6_A1.3.1-A1.3.4 - FORMATTED.txt"
    
    transcript_lines = process_log_file(log_file)
    create_original_transcript(transcript_lines, original_output)
    create_formatted_transcript(transcript_lines, formatted_output, "6", "A1.3.1-A1.3.4")
